...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/gateware/mega99_mega65r6_top.v"]"\
 ...
 "[file normalize "$origin_dir/gateware/spmmio_tipi.v"]"\
 ...
 "[file normalize "$origin_dir/vivado/mega99_mega65r6.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "mega99_mega65r6"
...
set script_file "mega99_mega65r6.tcl"
...
set_property -name "top" -value "mega99_mega65r6_top" -objects $obj
...
set file "[file normalize "$origin_dir/vivado/mega99_mega65r6.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/vivado/mega99_mega65r6.xdc"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/vivado/mega99_mega65r6.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/vivado/mega99_mega65r6.xdc"]" -objects $obj
...
set_msg_config -suppress -id {Synth 8-3917} -string {VDAC_PSAVE_N}
set_msg_config -suppress -id {Synth 8-3917} -string {AUDIO_SMUTE}
set_msg_config -suppress -id {Synth 8-3917} -string {AUDIO_SCL}
set_msg_config -suppress -id {Synth 8-3917} -string {AUDIO_SDA}
set_msg_config -suppress -id {Synth 8-3917} -string {HIZ_EN}
set_msg_config -suppress -id {Synth 8-3917} -string {LS_OE}
set_msg_config -suppress -id {Synth 8-3917} -string {FA_DOWN_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FA_UP_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FA_LEFT_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FA_RIGHT_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FA_FIRE_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FB_DOWN_O}
set_msg_config -suppress -id {Synth 8-3917} -string {FB_UP_O}
...
set_msg_config -id {Synth 8-7129} -string {{.*Port d\[.*\] in module spmmio_tipi.*}} -regexp -suppress
set_msg_config -id {Synth 8-7129} -string {{.*Port sel\[.*\] in module spmmio_tipi.*}} -regexp -suppress
